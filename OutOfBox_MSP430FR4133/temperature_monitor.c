...
#define TEMPERATURE_THRESHOLD_C 291  // 設定threshold為 29.0°C
#define TEMPERATURE_THRESHOLD_F 830  // 設定threshold為 83.0°F



void checkTemperatureAndTriggerLED_C(unsigned short current_temp) {
...
void checkTemperatureAndTriggerLED_F(unsigned short current_temp) {
